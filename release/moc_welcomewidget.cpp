...
**
** Created: Thu Dec 30 11:46:48 2010
...
static const char qt_meta_stringdata_WelcomeWidget[] = {
    "WelcomeWidget\0"
};

const QMetaObject WelcomeWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_WelcomeWidget,
      qt_meta_data_WelcomeWidget, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &WelcomeWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WelcomeWidget))
